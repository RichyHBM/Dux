 ...
 */
public class LeaderboardViewTest extends WithApplication {

    @Test
    public void leaderboardViewNullUserTest() {
        BasicAuthViewResponse response = new BasicAuthViewResponse("Leaderboards", null);
        ObjectNode viewData = Json.newObject();
        viewData.put("LeaderboardName", "test");
        Content html = views.html.leaderboard.render(viewData, response);
    ...
    @Test
    public void leaderboardViewWithUserTest() {
