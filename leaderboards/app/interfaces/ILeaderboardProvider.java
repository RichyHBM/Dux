...
public interface ILeaderboardProvider {
    ...
    List<LeaderboardUser> getRankedUsers(int gameId, String leaderboardId, long fromRank, int count);
    LeaderboardUser getUser(int gameId, String leaderboardId, String userId);
    long getRankForUser(int gameId, String leaderboardId, String userId);
